class Box {
  ...
  class Game {
      ...
      return function() {
        ...
        if (blankBox) {
          ...
          if (isSolved(newGrid)) {
            ...
            document.getElementById('final-moves').textContent = this.state.move + 1;
    ...
    render() {
      ...
      if (status === "ready") {
        controlBtn.innerHTML = '<i class="fas fa-play"></i> Jugar';
      } else if (status === "playing") {
        controlBtn.innerHTML = '<i class="fas fa-redo"></i> Reiniciar';
      }
