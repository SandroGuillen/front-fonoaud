  ...
  formValoracion.addEventListener("submit", function (e) {
    ...
    const valoracion = {
      ...
      desarrolloAlimentacion: {
        ...
        alimentacionComplementaria: document.getElementById(
          "alimentacionComplementaria"
        ).value,
      },
      audicion: {
        respuestaEstimulacion: document.getElementById("respuestaEstimulacion")
          .value,
        identificacionSonidos: document.getElementById("identificacionSonidos")
          .value,
      ...
      areaMiofuncional: {
        estructurasEstomatognaticas: document.getElementById(
          "estructurasEstomatognaticas"
        ).value,
        deglucion: document.getElementById("deglucion").value,
      },
      comunicacionLenguaje: document.getElementById("comunicacionLenguaje")
        .value,
      precesoAlimentacionDeglucion: document.getElementById(
        "procesoAlimentacionDeglucion"
      ).value,
      conclusionDiagnostica: document.getElementById("conclusionDiagnostica")
        .value,
      planIntervencion: {
        objetivosGenerales: document.getElementById("objetivosGenerales").value,
        objetivosEspecificos: document
          .getElementById("objetivosEspecificos")
          .value.split(";"),
      },
      recomendaciones: {
        terapiaFonoaudiologica: document.getElementById(
          "terapiaFonoaudiologica"
        ).value,
      },
    };
