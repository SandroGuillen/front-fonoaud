...
function bloquearTarjetas() {
  for (let i = 0; i <= 15; i++) {
    ...
    tarjetaBloqueada.innerHTML = `<img src="./img/${numeros[i]}.png" alt="Emoción ${numeros[i]}">`;
...
function destapar(id) {
  ...
  if (tarjetasDestapadas == 1) {
    ...
    tarjeta1.innerHTML = `<img src="./img/${primerResultado}.png" alt="Emoción ${primerResultado}">`;
    clickAudio.play();
    ...
    tarjeta2.innerHTML = `<img src="./img/${segundoResultado}.png" alt="Emoción ${segundoResultado}">`;
      ...
      if (Aciertos == 8) {
        ...
        if (typeof onEndGame === "function") {
          onEndGame({
            ...
            gameName: "Juego_Memoria_Emociones",
...
function mostrarVictoria() {
  ...
  overlay.innerHTML = `
        <div class="mensaje-victoria">
            <h2>¡Felicidades! 🎉</h2>
            <p>Has completado el juego de memoria de emociones</p>
